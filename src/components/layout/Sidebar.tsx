    ...
    <>
      ...
      >
        <div className="h-full flex flex-col">
                ...
                <Link
                  ...
                  className={[
                    ...
                    active
                      ...
                      : "text-sky-50/95 hover:bg-white/10 hover:text-white",
                  ].join(" ")}
                >
                  <Icon
                    k={m.iconKey}
                    className={
                      active
                        ? "text-sky-700 h-5 w-5"
                        : "text-sky-100/80 h-5 w-5"
                    }
                  />
          ...
          {/* Bottom Utilities */}
          <div
            className="absolute bottom-0 left-0 right-0 px-2 py-3 border-t border-white/15
                bg-gradient-to-t from-blue-900/70 via-blue-900/40 to-transparent backdrop-blur"
          >
            <button
              onClick={onLogout}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl text-sm
